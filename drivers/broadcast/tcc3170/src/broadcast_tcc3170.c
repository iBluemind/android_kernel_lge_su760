...
int tdmb_tcc3170_mdelay(int32 ms)
{
	...
	if(rc == 0)
	{
		printk("tdmb_tcc3170_delay return abnormal\n");
	}
...
int tdmb_tcc3170_power_on(void)
{
	...
	{
		printk("tdmb_tcc3170_power_on function NULL\n");
...
int tdmb_tcc3170_power_off(void)
{
    ...
    {
        printk("tdmb_tcc3170_power is immediately off\n");
    ...
    {
        printk("tdmb_tcc3170_power_off function NULL\n");
...
static int  broadcast_tcc3170_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	printk("broadcast_tcc3170_i2c_probe( ) client:0x%X\n", (unsigned int)client);

	if(!i2c_check_functionality(client->adapter, I2C_FUNC_I2C)) {
		printk(KERN_ERR "tdmb_tcc3170_i2c_probe: need I2C_FUNC_I2C\n");
	...
	{
		printk("broadcast_tcc3170_i2c_probe dmb_gpio_init is not called\n");
	}
...
{
	printk("broadcast_tcc3170_i2c_remove is called\n");
...
#endif //__CSPI_ONLY__
	printk("broadcast_add_driver rc = (%d)\n", rc);
	return rc;
}
