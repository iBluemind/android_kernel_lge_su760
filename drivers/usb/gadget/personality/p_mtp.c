...
static ssize_t ep_in_write(struct file *f, struct kobject *kobj, struct bin_attribute *bin_attr,
...
static ssize_t ep_out_read(struct file *f, struct kobject *kobj, struct bin_attribute *bin_attr,
                           char *buffer, loff_t offset, size_t buffer_size)
{
  struct mtp_function* mtp_func = kobject_to_mtp_function(kobj);
  DBG(mtp_func->cdev, "%s\n", __func__);
...
static ssize_t ep_int_write(struct file *f, struct kobject *kobj, struct bin_attribute *bin_attr,
                            char *buffer, loff_t offset, size_t buffer_size)
{
  struct mtp_function* mtp_func = kobject_to_mtp_function(kobj);
  DBG(mtp_func->cdev, "%s\n", __func__);
...
static ssize_t ep_int_stall(struct file *f, struct kobject *kobj, struct bin_attribute *bin_attr,
                            char *buffer, loff_t offset, size_t buffer_size)
{
  struct mtp_function* mtp_func = kobject_to_mtp_function(kobj);
...
static ssize_t control_read(struct file* f, struct kobject *kobj, struct bin_attribute *bin_attr,
                            char *buffer, loff_t offset, size_t buffer_size)
{
  struct mtp_function* mtp_func = kobject_to_mtp_function(kobj);
  DBG(mtp_func->cdev, "%s\n", __func__);
...
static ssize_t control_write(struct file* f, struct kobject *kobj, struct bin_attribute *bin_attr,
                             char *buffer, loff_t offset, size_t buffer_size)
{
  struct mtp_function* mtp_func = kobject_to_mtp_function(kobj);
  DBG(mtp_func->cdev, "%s\n", __func__);
